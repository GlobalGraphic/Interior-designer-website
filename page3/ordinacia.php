...
<div class="container">
	<div class="row">
    <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/02.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/03.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/04.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/05.jpg" alt="fotka1" class="img-fluid">
  </div>
    <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/06.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/07.jpg" alt="fotka" class="img-fluid">
  </div>
    <div class="col-lg-4">
		<img src="../img/komercne_priestory/ordinacia/08.jpg" alt="fotka" class="img-fluid">
  </div>
	</div>
</div>
