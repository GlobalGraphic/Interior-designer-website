...
<div class="container">
  <div class="row">
    <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_08.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_09.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_10.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_11.jpg" alt="fotka1" class="img-fluid">
  </div>
    <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_12.jpg" alt="fotka" class="img-fluid">
  </div>
  <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_13.jpg" alt="fotka" class="img-fluid">
  </div>
    <div class="col-lg-4">
    <img src="../img/rodinne_domy/d4/Machac_14.jpg" alt="fotka" class="img-fluid">
  </div>
  </div>
</div>
