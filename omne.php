...
<div class="container" style="font-family: Raleway;">
  <div class="row">
  <div class="col-lg-4">
    <img src="omne.jpg" alt="Ja" class="img-fluid">
  </div>
    <div class="col-lg-7">
    <p class="bold">Som dizajnérka Kamila Adámková</p> <p class="text">pôsobiaca aktívne na Slovensku a v Českej republike. V obore sa pohybujem 18 rokov a za tú dobu som zrealizovala stovky projektov interiéru.<br><br> Kladiem dôraz nielen na estetickú stránku, ale zohľadňujem aj funkčnosť a praktičnosť.<br><br> Snážím sa vytvoriť domov, interiér v ktorom sa ľudia cítia pohodlne a príjemne.<br><br> Keď uvažujete o novom bývaní či rekonštrukcii, je pravý čas sa obrátiť na interierového dizajnéra, teda na mňa.<br><br> Pustiť sa do zariaďovania interiéru bez detailne premysleného konceptu, može byť časovo i finančne náročné s neistým výsledkom.</p>
  </div>
</div>
</div>
